# toxic language flask app midterm project
-----
* this flask app starts with a boilerplate [alectrocute's flaskSaas repo](https://github.com/alectrocute/flaskSaaS) (see below). Then we added an NLP model, and Stripe.
* the models were created using the kaggle competition data for toxic comments
...
* to create a conda environment use this command
```
conda env create -f environment.yml
```

# infor about flaskSaas
---
...
- You need to have an account with stripe, obtain the API keys, and update the appropriate files with it. 
